...
<div class="grid_10" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<h3 class="title_black"><?php echo $this->lang->line('bill_number') . ' ' . bill_id($bill); ?></h3>

		<?php $this->load->view('dashboard/system_messages'); ?>

		<div class="content toggle">

			<form method="post" action="<?php echo site_url($this->uri->uri_string()); ?>" name="bill_item_form">
				...
				<dl>
					<dt><label><?php echo $this->lang->line('apply_bill_tax'); ?>: </label></dt>
