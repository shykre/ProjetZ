<table style="width: 100%;">
	...
	<tr>
		<td style="text-align: left;"><?php echo $history_item->bill_number; ?></td>
		<td style="text-align: left;"><?php echo format_date($history_item->bill_history_date); ?></td>
		<td style="text-align: left;"><?php echo $history_item->username; ?></td>
		<td style="text-align: left;"><?php echo $history_item->bill_history_data; ?></td>
	</tr>
		<?php } ?>
</table>
