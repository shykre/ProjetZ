...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>
			<?php echo $this->lang->line('bill_number'); ?>
	...
	<body>
		...
		<table width="100%">
			<tr>
				...
				<td width="40%" align="right" valign="top">
					<h2><?php echo $this->lang->line('bill'); ?></h2>
					<p class="notop">
						<?php echo $this->lang->line('bill_number'); ?>
						<?php echo bill_id($bill); ?><br />
						<?php echo $this->lang->line('bill_date'); ?>:
						<?php echo bill_date_entered($bill); ?><br />
						<?php echo $this->lang->line('due_date'); ?>:
						<?php echo bill_due_date($bill); ?>
					</p>
		...
		<table style="width: 100%;">
			...
			<tr>
                ...
                <td align="right">
                    <?php echo bill_item_tax_rate($item); ?>
                </td>
				<td align="right">
