<?php $this->load->view('dashboard/header', array('header_insert'=>'bills/bill_edit_header')); ?>
...
<div class="grid_10" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<h3 class="title_black"><?php echo ($bill->bill_is_quote == 1 ? $this->lang->line('quote_number') : $this->lang->line('bill_number')) . ' ' . $bill->bill_number; ?>
			...
			<?php } else { ?>
			<input type="submit" name="btn_quote_to_bill" style="float: right; margin-top: 10px; margin-right: 10px;" value="<?php echo $this->lang->line('quote_to_bill'); ?>" />
			<?php } ?>
			<input type="submit" name="btn_add_new_item" style="float: right; margin-top: 10px; margin-right: 10px;" value="<?php echo $this->lang->line('add_bill_item'); ?>" />
		...
		<div class="content toggle">
				...
				<div id="tabs">
					<ul>
						...
						<?php if (!$this->mdl_mcb_data->setting('disable_bill_audit_history')) { ?>
